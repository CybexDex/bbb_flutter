...
class MaterialSegmentedControl<T> extends StatefulWidget {
  ...
  MaterialSegmentedControl({
    ...
    this.horizontalPadding = _horizontalPadding,
        ...
        assert((disabledChildren == null || (disabledColor != null && disabledChildren != null)),
        ...
        assert(
          selectionIndex == null || children.keys.any((T child) => child == selectionIndex),
...
class _SegmentedControlState<T> extends State<MaterialSegmentedControl<T>>
  ...
  Widget build(BuildContext context) {
    ...
    for (T currentKey in widget.children.keys) {
      selectedIndex = (widget.selectionIndex == currentKey) ? index : selectedIndex;
      ...
      _backgroundColors
          .add(checkDisabledChild ? widget.disabledColor : getBackgroundColor(index, currentKey));
...
class _RenderSegmentedControl<T> extends RenderBox
  ...
  void _layoutRects(_NextChild nextChild, RenderBox leftChild, RenderBox rightChild) {
    ...
    while (child != null) {
      ...
      final Rect childRect = Rect.fromLTWH(start, 0.0, child.size.width, child.size.height * 3 / 4);
      RRect rChildRect;
      if (child == leftChild) {
      ...
      start += child.size.width - child.size.width / 4;
  ...
  void _paintChild(PaintingContext context, Offset offset, RenderBox child, int childIndex) {
    ...
    context.paintChild(child, childParentData.offset + Offset(offset.dx, offset.dy - 6));
  }
