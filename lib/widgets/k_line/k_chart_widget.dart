...
import 'package:bbb_flutter/widgets/k_line/renderer/base_chart_painter.dart';
...
class KChartWidget extends StatefulWidget {
  ...
  @override
  _KChartWidgetState createState() {
    return _KChartWidgetState();
  }
}
...
class _KChartWidgetState extends State<KChartWidget>
  ...
  Widget build(BuildContext context) {
    BaseChartPainter painter = ChartPainter(
        datas: widget.datas,
        scaleX: mScaleX,
        scrollX: mScrollX,
        selectX: mSelectX,
    ...
    return GestureDetector(
      ...
      onLongPressMoveUpdate: (details) {
        if (mSelectX != details.globalPosition.dx) {
          if (painter.calculateSelectedX(mSelectX) !=
              painter.calculateSelectedX(details.globalPosition.dx)) {
            HapticFeedback.lightImpact();
          }
          mSelectX = details.globalPosition.dx;
          notifyChanged();
