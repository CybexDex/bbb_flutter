...
class ChartColors {
  ...
  static const Color upColor = Palette.appGreen;
  static const Color dnColor = Palette.appRed;
  ...
  static const Color maxMinTextColor = Colors.black; //最大最小值的颜色
