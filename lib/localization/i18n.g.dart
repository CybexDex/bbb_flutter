...
class _$Keys {
  ...
  static final String transferRecords = 'transfer_records';

  static final String transferIn = 'transfer_in';

  static final String transferOut = 'transfer_out';

  static final String transactionRecords = 'transaction_records';

  static final String rewardRecords = 'reward_records';
  ...
  static final String loginTitle = 'login_title';

  static final String loginProtectPassword = 'login_protect_password';
  ...
  static final String registerGetPinCode = 'register_get_pin_code';

  static final String registerChangePinCode = 'register_change_pin_code';
  ...
  static final String inviteRule = 'invite_rule';
  ...
  static final String profitAndLoss = 'profit_and_loss';
  ...
  static final String navHome = 'nav_home';

  static final String navTransaction = 'nav_transaction';

  static final String navForum = 'nav_forum';

  static final String navAccount = 'nav_account';
  ...
  static final String exchangeChangeRatio = 'exchange_change_ratio';
...
abstract class _$I18nHelper {
  ...
  String get transferRecords => this._translate(_$Keys.transferRecords);
  String get transferIn => this._translate(_$Keys.transferIn);
  String get transferOut => this._translate(_$Keys.transferOut);
  String get transactionRecords => this._translate(_$Keys.transactionRecords);
  String get rewardRecords => this._translate(_$Keys.rewardRecords);
  ...
  String get loginTitle => this._translate(_$Keys.loginTitle);
  String get loginProtectPassword =>
      this._translate(_$Keys.loginProtectPassword);
  ...
  String get registerGetPinCode => this._translate(_$Keys.registerGetPinCode);
  String get registerChangePinCode =>
      this._translate(_$Keys.registerChangePinCode);
  ...
  String get inviteRule => this._translate(_$Keys.inviteRule);
  ...
  String get line => this._translate(_$Keys.line);
  ...
  String get navHome => this._translate(_$Keys.navHome);
  String get navTransaction => this._translate(_$Keys.navTransaction);
  String get navForum => this._translate(_$Keys.navForum);
  String get navAccount => this._translate(_$Keys.navAccount);
