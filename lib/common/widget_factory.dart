...
//  static buttonTopBottomPadding = Padding();
  static Padding buttonTopBottomPadding(Widget child) => Padding(padding: EdgeInsets.only(top: Dimen.buttonTopPadding, bottom: Dimen.buttonTopPadding), child: child);

  static RaisedButton button({String data, Color color, @required VoidCallback onPressed}) {
    return RaisedButton(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(Dimen.corner)),
        onPressed: onPressed,
        color: color,
