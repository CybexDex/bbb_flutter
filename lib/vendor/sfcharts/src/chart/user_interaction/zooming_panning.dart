...
class ZoomPanBehavior extends ZoomBehavior {
  ...
  Rect _zoomingRect = Rect.fromLTWH(0, 0, 0, 0);
    ...
    for (int axisIndex = 0;
      ...
      if ((axis._orientation == AxisOrientation.vertical &&
        ...
        if (cumulative >= 1) {
          ...
          axis._zoomFactor = zoomFactor;
          axis._bounds = Rect.fromLTWH(0, 0, 0, 0);
      ...
      if ((axis._orientation == AxisOrientation.vertical &&
        ...
        if (axis._orientation == AxisOrientation.horizontal) {
          value = (_previousMovedPosition.dx - xPos) /
              ...
              currentScale;
          currentZoomPosition =
              _minMax(axis._zoomPosition + value, 0, 1 - axis._zoomFactor)
                  .toDouble();
  ...
  void _doSelectionZooming(Rect zoomRect) {
    ...
    zoomRect = Rect.fromLTRB(0, 0, 0, 0);
    _rectPath = Path();
    _createZoomState();
  }
